...
export default function Services() {
  const services = [
    ...
    { icon: '🔄', title: 'Transmission Service', desc: 'Fluid flushes, repairs, and rebuilds for automatic and manual transmissions.' },
    ...
    { icon: '💨', title: 'Exhaust & Emissions', desc: 'Muffler, catalytic converter, pipes, and emissions testing.' },
